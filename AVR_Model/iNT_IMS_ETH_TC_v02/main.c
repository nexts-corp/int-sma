...
{                                 
    ...
    int ivADC = 0;   
    float ivADCFloat = 0.0;
    float ivVolt = 0.0; 
    float ivVoltPlusffset = 0.0;
    float ivTempC = 0.0;  
    float ivVoltzero = 0.0;
    float ivZero = 1.68; 
    
    long viADCbuffer = 0;
    
    float ivADCbuffFloat = 0.0;    
    int j = 0;
...
//        viADCbuffer = 0;
//        for(j=0;j<30;j++){
//           viADCbuffer += read_adc(8);
//        }
//        //printDebug("ADC[0] Temp C : %f\r\n",iAD595ADCToTemp(viADCbuffer,30));  
//        iAD595ADCToTemp(viADCbuffer,30);
//        delay_ms(500);
//    }
...
//            printRTC(st_rtc);
        ...
        /*bongkot test*/
//        operating_config.deviceEnable = 1;
//        operating_config.sensorEnable[0] = 1; 
//        operating_config.sensorEnable[1] = 0;
//        operating_config.sensorEnable[2] = 0;
//        operating_config.sensorEnable[3] = 0;
//        operating_config.sensorEnable[4] = 0;
...
//            operating_config.mode = MODE_REALTIME;      //test
            ...
            /*bongkot test*/
            operating_config.mode == MODE_REALTIME;
