...
#define GSM_VEN_PORT					GPIOE
#define GSM_VEN_PIN						GPIO_Pin_1				/* VGSM Enable/Disable 1 = Enable 0 = Disable */
#define GSM_RESET_PORT				GPIOD		
#define GSM_RESET_PIN					GPIO_Pin_5				/* GSM Module Reset PIN 0 = Reset (Please check timing in Datasheet again) */
#define GSM_PWR_PORT					GPIOD		
#define GSM_PWR_PIN						GPIO_Pin_6				/* GSM Module PowerKey 0 = On (Please check timing in Datasheet again) */
#define GSM_STATUS_PORT				GPIOE		
#define GSM_STATUS_PIN				GPIO_Pin_7				/* GSM Module Status */
#define GSM_NETMODE_PORT			GPIOE		
#define GSM_NETMODE_PIN				GPIO_Pin_8				/* GSM Module Net_Mode */
#define GSM_SLEEP_PORT				GPIOE		
#define GSM_SLEEP_PIN					GPIO_Pin_9				/* GSM Module Sleep_IND */


#define LED_CSQ_PORT					GPIOD		
#define LED_CSQ_PIN						GPIO_Pin_15				/* GSM Signal Status */
...
#define LED_CONNSERVER_PIN		GPIO_Pin_14				/* Connect Server Status */
...
#define LED_SAMP_PIN					GPIO_Pin_13				/* Sampling Data */
...
#define LED_SENT_PIN					GPIO_Pin_12				/* Sent Data */
...
#define LED_SD_PIN						GPIO_Pin_11				/* SD Card Status */
...
#define LED_ERR_PIN						GPIO_Pin_10				/* Error Indicator */
...
#define BUZZER_PIN						GPIO_Pin_7				/* Buzzer */
