...
/* MTI-SMA Version */
#define SMAV2015				0x01				/* SMA-1 2015 Version */

/* MTI-SMA Message class */
#define AUTHMESC				0x01				/* Authorization Message */
#define TRANMESC				0x02				/* Transaction Message */
#define BATUMESC				0x03				/* Batch upload Message */
#define SETMMESC				0x05				/* Settlement Message */
#define HOREMESC				0x08				/* Host Request Message */

/* MTI-SMA Message function */
#define REQUMESF				0x00				/* Request function */
#define RESPMESF				0x01				/* Response function */
...
#define HOSTREQC				0x00				/* Host request COMMAND */
...
#define HOSTRESA				0x00				/* Host response COMMAND */
 ...
 */
#define INDEX2_MTI						0
#define INDEX2_RECVADDR				2
#define INDEX2_TIME						10
#define INDEX2_FRAMEID				14
#define INDEX2_FRAMETYPE			16

/* Configuration Packet Index */
#define INDEX2_CONFIG_ACCD		17
#define INDEX2_CONFIG_CNFG		18
...
/* Response ACK Packet Index */
#define INDEX_RESPONSE_CMD		18
#define INDEX_RESPONSE_STAT		19
...
extern uint16_t		_DataLog_WaitID;
extern uint16_t		_EventLog_WaitID;
extern uint16_t		_ConfigLog_WaitID;
