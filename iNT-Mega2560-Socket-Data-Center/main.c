...
//        }
        ...
        /**
           bongkot test data;
        **/
//        operating_config.alarmEnable = 0;
//        operating_config.deviceEnable = 1; 
//        operating_config.mode = 0;
//        operating_config.sensorEnable[0] = 1; 
//        operating_config.sensorEnable[1] = 1;
//        operating_config.sensorEnable[2] = 1;
//        operating_config.sensorEnable[3] = 1;
//        operating_config.sensorEnable[4] = 1;
...
int sensorDataSave(void)
{
    ...
    {
        res = fetchDataQueue(&timestamp, &channel, &value);
        if(res < 0)    //queue empty
        {
            break;
        }
        else          //there are data in queue
        {   
